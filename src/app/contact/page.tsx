...
import { PHONE_NUMBER, PHONE_HREF, COMPANY_INFO } from "@/lib/constants"
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3"><div><p className="font-semibold">Email</p><EmailLink user="info" domain="agingwellcare.com" /></div></div>
